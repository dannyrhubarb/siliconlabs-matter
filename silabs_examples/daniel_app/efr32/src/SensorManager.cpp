...
constexpr uint16_t kMinTemperatureDelta  = 10;    // 0.5 degree Celcius
...
void SensorManager::SensorTimerEventHandler(TimerHandle_t xTimer)
{
    ...
    static uint32_t lastHumidity = 0;

#ifdef USE_TEMP_SENSOR
    SILABS_LOG("Real Temp");
    int32_t tempSum   = 0;
    ...
    humidity = humiditySum / 100;
#else
    SILABS_LOG("Simulating Temp");
    ...
    SILABS_LOG("Sensor Temp is: %d and humidity: %d", temperature, humidity);

    if ((temperature >= (lastTemperature + kMinTemperatureDelta)) || temperature <= (lastTemperature - kMinTemperatureDelta) || humidity != lastHumidity)
    {
        ...
        app::Clusters::TemperatureMeasurement::Attributes::MeasuredValue::Set(1, temperature + 540);
        app::Clusters::TemperatureMeasurement::Attributes::MinMeasuredValue::Set(1, 800);
        app::Clusters::TemperatureMeasurement::Attributes::MaxMeasuredValue::Set(1, 3000);
        app::Clusters::RelativeHumidityMeasurement::Attributes::MeasuredValue::Set(2, humidity/10);
